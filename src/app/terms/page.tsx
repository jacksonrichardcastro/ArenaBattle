  ...
  return (
    <div className="container" style={{ padding: '3rem 1.5rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ lineHeight: '1.6', color: 'var(--text-secondary)' }}>
        ...
        <p>By accessing or using the ArenaBattle platform, you agree to be bound by these Terms of Service. If you do not agree to these terms, simply do not use the platform.</p>
        ...
        <p>ArenaBattle takes a flat 10% platform fee from the total gross prize pool of any finalized, non-canceled match.</p>
