  ...
  return (
    <div className="container" style={{ padding: '3rem 1.5rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ lineHeight: '1.6', color: 'var(--text-secondary)' }}>
        ...
        <p>We use this information explicitly to provide the ArenaBattle matchmaking services and ensure proper monetary payouts. We do not sell your personal data to ad networks.</p>
